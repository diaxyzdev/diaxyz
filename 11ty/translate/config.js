// Enables or disables the entire translation pipeline during the build process.
export const TRANSLATE = (process.env.TRANSLATE || 0) == 1;
...
export const SAVE_TRANSLATIONS = (process.env.TRANSLATE_SAVE_TRANSLATIONS || 0) == 1;
...
console.error(`TRANSLATE:${TRANSLATE}`);
