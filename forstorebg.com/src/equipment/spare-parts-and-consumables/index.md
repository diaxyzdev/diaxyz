...
tags: - equipment - spare-parts-and-consumables --- tags: - equipment -
...
<main>
  <main class="Services-module__3bADUG__page">
    <section class="Services-module__3bADUG__hero">
      <img
        alt="Spare parts and consumables"
        class="Services-module__3bADUG__heroImage"
        src="/assets/images/equipment/spare-parts-and-consumables/img_1_1ac1be5758.webp"
        style="
          position: absolute;
          height: 100%;
          width: 100%;
        ...
        <div class="styles.serviceGrid Services-module__3bADUG__serviceGrid">
          ...
          <div class="Services-module__3bADUG__imageWrapper">
            <img
              ...
              height="600"
              src="/assets/images/equipment/spare-parts-and-consumables/img_2_ab7f35d015.webp"
    ...
    <section
      class="Services-module__3bADUG__serviceSection Services-module__3bADUG__reverse"
      id="tyagovi-baterii-i-zaryadni-ustroystva"
    >
      <div class="Services-module__3bADUG__contentTitle">
        <div class="SectionTitle-module__Svbyca__container">
          <span
      ...
      <div class="Services-module__3bADUG__container">
        <div class="styles.serviceGrid Services-module__3bADUG__serviceGrid">
          ...
          <div class="Services-module__3bADUG__imageWrapper">
            <img
              alt="Traction batteries and chargers"
              class="Services-module__3bADUG__productImage"
              height="600"
              src="/assets/images/equipment/spare-parts-and-consumables/img_3_e614746f4e.webp"
              style="color: transparent"
              title="Traction batteries and chargers"
              width="800"
            />
    ...
    <section
      class="Services-module__3bADUG__serviceSection Services-module__3bADUG__reverse"
      id="industrialni-gumi-i-bandazhni-koleleta"
    >
      <div class="Services-module__3bADUG__contentTitle">
        <div class="SectionTitle-module__Svbyca__container">
          <span
      ...
      <div class="Services-module__3bADUG__container">
        <div class="styles.serviceGrid Services-module__3bADUG__serviceGrid">
          ...
          <div class="Services-module__3bADUG__imageWrapper">
            <img
              alt="Industrial tires and tire wheels"
              class="Services-module__3bADUG__productImage"
              height="600"
              src="/assets/images/equipment/spare-parts-and-consumables/img_4_8897d6e47e.webp"
              style="color: transparent"
              title="Industrial tires and tire wheels"
              width="800"
            />
